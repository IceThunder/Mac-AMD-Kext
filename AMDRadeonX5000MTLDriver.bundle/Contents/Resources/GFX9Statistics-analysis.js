...
function analysis_TextureSamplingInst_bound()
{
    ...
    if ((ShaderCoreALUActive < ALUActiveThreshold) && (MemoryStallPerWavefrontCompute > MemoryStallThreshold) && (MTLStatComputeCost > ShaderCostThreshold) && (TextureUnitBusy > TextureUnitBusyThreshold))
    {
    ...
    if ((ShaderCoreALUActive < ALUActiveThreshold) && (MemoryStallPerWavefrontVertex > MemoryStallThreshold) && (MTLStatVertexCost > ShaderCostThreshold) && (TextureUnitBusy > TextureUnitBusyThreshold))
    {
        specificShaderStall = true;
    ...
    if ((ShaderCoreALUActive < ALUActiveThreshold) && (MemoryStallPerWavefrontFragment > MemoryStallThreshold) && (MTLStatFragmentCost > ShaderCostThreshold) && (TextureUnitBusy > TextureUnitBusyThreshold))
    {
        specificShaderStall = true;
    ...
    if (specificShaderStall == false && (ShaderCoreALUActive < ALUActiveThreshold) && (MemoryStallPerWavefront > MemoryStallThreshold) && (MTLStatShaderCost > ShaderCostThreshold) && (TextureUnitBusy > TextureUnitBusyThreshold))
    {
